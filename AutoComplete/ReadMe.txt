...
How to use?
Three datasets vary in size have been included in the Data Sets folder along with all the names in those datasets( found in 100Names.txt). dataset_2.csv includes infos about the first 2 trading_names in 100Names.txt and dataset_20.csv contains infos about the first 20 trading_names and so on. Put the keyword you want to search in Input.txt. Multiple keywords can be included in the file, with each keyword on seperate new line. Then run the following in console:
 1. make -B dict
